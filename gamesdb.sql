...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3600977541ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gamesdb&table=gameinfos">`gamesdb`.`gameinfos`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gamesdb&table=steamgameurlsandtitles">`gamesdb`.`steamgameurlsandtitles`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gamesdb&table=steamgametagurls">`gamesdb`.`steamgametagurls`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=slidemedb&table=appinfos">`slidemedb`.`appinfos`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=slidemedb&table=gameurlandname">`slidemedb`.`gameurlandname`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=giantbomb&table=gameinfos">`giantbomb`.`gameinfos`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=giantbomb&table=gameids">`giantbomb`.`gameids`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=yii2basic&table=country">`yii2basic`.`country`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=performance_schema&table=accounts">`performance_schema`.`accounts`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="5e7e29596a212763382b3b2e566f3c2b">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="giantbomb" targettable="gameids">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `gameids`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="giantbomb" targettable="gameids">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            targetdb="giantbomb" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">INSERT into gameIds VALUES (&#039;Saboteur&#039;, &#039;3030-82&#039;, &#039;82&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="giantbomb" targettable="gameids">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `gameids`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="giantbomb" targettable="gameinfos">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `gameinfos`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="slidemedb" targettable="appinfos">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `appinfos`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="slidemedb" targettable="gameurlandname">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `gameurlandname`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="slidemedb" targettable="gameurlandname">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `appinfos`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="gamesdb" targettable="gameinfos">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `gameinfos`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="gamesdb" targettable="steamgametagurls">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `steamgametagurls`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="gamesdb" targettable="steamgameurlsandtitles">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `steamgameurlsandtitles`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="gamesdb" targettable="steamgametagurls">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT `url` FROM `gameinfos` WHERE `gameinfos`.`url` = &#039;https://store.steampowered.com/app/10/CounterStrike/?snr=1_7_7_240_150_1&#039;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="gamesdb" targettable="gameinfos">
                            <div class="action_content">
